...
public class BookConfirmation {
	...
	BookConfirmation(Student StudentInfo, Faculty facultyInfo, String Isbn, boolean isreserved, int resourceID) {
		...
		Submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					prepstat.setString(7, "Books");
					prepstat.setString(8, ISBN);
					ResultSet rset = prepstat.executeQuery();

					prepstat = connect.prepareStatement(SqlQueries.UPDATEBOOKCOUNTER);
					prepstat.setString(1, Isbn);
					rset = prepstat.executeQuery();

					JOptionPane.showMessageDialog(null, "The respective book have been issued");
					rset.close();
					prepstat.close();
					connect.close();
					f1.setVisible(false);
